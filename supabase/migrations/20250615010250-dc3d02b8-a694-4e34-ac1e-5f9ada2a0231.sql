...
-- Vamos primeiro verificar as URLs atuais e corrigir as associações incorretas
-- Baseado nos logs, vou mapear corretamente as imagens para os perfis

UPDATE public.profiles 
SET foto_url = CASE 
  WHEN name = 'Juliana Santos Oliveira' THEN '/lovable-uploads/43e938c7-f896-452b-a284-3c9df63f213f.png'
  WHEN name = 'Roberto Silva Mendes' THEN '/lovable-uploads/67816a9d-4783-48d7-a5ea-020683c86e12.png'
  WHEN name = 'Ana Lucia Chen' THEN '/lovable-uploads/2ee6157e-fd08-4e0b-9189-84fa52673c3b.jpg'
  WHEN name = 'Hiroshi Tanaka' THEN '/lovable-uploads/c07ab9f3-3adc-43c4-83c8-dac05c9c9fc3.jpg'
